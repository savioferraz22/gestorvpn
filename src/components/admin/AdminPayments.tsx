  ...
  return (
    <div className="flex-1 overflow-y-auto">
      <div className="mx-auto flex max-w-7xl flex-col gap-4 p-4 sm:p-6">
          ...
          actions={
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-md border border-success/30 bg-success-soft px-2.5 h-8 text-xs font-bold text-success hover:bg-success/15 transition-colors disabled:opacity-50"
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-md border border-warning/30 bg-warning-soft px-2.5 h-8 text-xs font-bold text-warning hover:bg-warning/15 transition-colors disabled:opacity-50"
        ...
        {reprocessMsg && (
          <div className="rounded-md border border-warning/30 bg-warning-soft px-3 py-2 text-xs font-medium text-warning">
            {reprocessMsg}
          </div>
        )}
