...
async function run() {
  await testModule("deleteuser", { user: "testuser123" });
  await testModule("deluser", { user: "testuser123" });
  await testModule("removeuser", { user: "testuser123" });
  await testModule("removeruser", { user: "testuser123" });
}
